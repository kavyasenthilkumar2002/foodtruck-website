/** @typedef {{ code: string, name: string, dial: string }} Country */
...
/** Apple-style flag image URL (matches glossy emoji in design reference). */
export function getFlagEmojiSrc(code) {
  const iso = (code || '').toUpperCase()
  if (iso.length !== 2) return null
  const unified = [...iso]
    .map((c) => (0x1f1e6 + c.charCodeAt(0) - 65).toString(16))
    .join('-')
  return `https://cdn.jsdelivr.net/npm/emoji-datasource-apple@15.1.1/img/apple/64/${unified}.png`
}
